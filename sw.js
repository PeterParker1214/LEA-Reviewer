...
const SHELL_URLS = [
  ...
  'chat.html',
  'assets/chat.js?v=81',
  'assets/messenger-model.js?v=81',
  'assets/messenger.js?v=81',
  'assets/messenger.css?v=81',
  'duel.html',
  'user.html',
  'about.html',
  'assets/notifications.js?v=81',
  'assets/reminders.js?v=81',
  'assets/whats-new.js?v=81',
  'assets/module-progress.js?v=81',
  'assets/sb-client.js?v=81',
  'assets/quiz-source.js?v=81',
  'assets/avatar.js?v=81',
  'assets/quiz-resume.js?v=81',
  'assets/lea-confirm.js?v=81',
  'assets/theme.js?v=81',
  'assets/icons.js?v=81',
  'assets/countdown.js?v=81',
  'assets/blueprint.css?v=81',
  'assets/leaderboard.css?v=81',
  'assets/leaderboard.js?v=81',
  'assets/legacy-desktop.css?v=81',
  'data/subjects.json',
  'favicon.svg?v=5',
  'favicon-32x32.png',
  'favicon-16x16.png',
...
function isManifest(url) {
  // changelog.json is how an open page learns a newer version exists, so a
  // cached copy would hide exactly the update it is meant to announce.
  return url.pathname.endsWith('/data/subjects.json') || url.pathname.endsWith('/data/changelog.json');
}
