...
const SHELL_URLS = [
  ...
  'chat.html',
  'assets/chat.js?v=79',
  'assets/messenger-model.js?v=79',
  'assets/messenger.js?v=79',
  'assets/messenger.css?v=79',
  'duel.html',
  'user.html',
  'about.html',
  'assets/notifications.js?v=78',
  'assets/reminders.js?v=78',
  'assets/whats-new.js?v=78',
  'assets/module-progress.js?v=78',
  'assets/quiz-source.js?v=78',
  'assets/avatar.js?v=78',
  'assets/quiz-resume.js?v=78',
  'assets/lea-confirm.js?v=78',
  'assets/theme.js?v=78',
  'assets/icons.js?v=78',
  'assets/countdown.js?v=78',
  'assets/blueprint.css?v=78',
  'assets/leaderboard.css?v=78',
  'assets/leaderboard.js?v=78',
  'assets/legacy-desktop.css?v=78',
  'data/subjects.json',
  'favicon.svg?v=5',
  'favicon-32x32.png',
  'favicon-16x16.png',
